...
#       - $my_workspace_oid
#
#       - Note 1: You may find your current/default workspace OID in your Subscription
#                 by visiting the following REST URL:
#                   https://rally1.rallydev.com/slm/webservice/v2.0/workspace/
#       - Note 2: To get a list of all Workspace OIDs in your Subscription, visit:
...
#       - Note 2: It's recommended to run this script as a Subscription Administrator,
#                 to ensure that access to all Workspaces/Projects/Artifacts of interest
#
#   2) Invoke the script:
#       ./export-workspace-attachments.rb
#
#   3) All attachments found will be saved in a file like:
#       - ./Saved_Attachments/WS###/FormattedID/attachment-###.<type>.<ext>
#      Where:
#       WS###       - is the ordinal workspace number found (1 based).
#       FormattedID - is the FormattedID of the Artifact, TestCaseResult or TestSet
...
#
failed_requires = 0
%w{rally_api  base64 pp}.each do |this_Require|
  begin
...
@my_workspace.each_with_index do | this_workspace, count_workspace | #{
    ...
    #   next
    #end
    print "Workspace %03d - Name=#{this_workspace.Name}  State=#{this_workspace.State}"%[count_workspace+1]
    ...
    all_workspace_attachments.each_with_index do |this_workspace_attachment, count_workspace_attachments| #{
        ...
        print "     Attachment[%03d]; on FormattedID=#{this_workspace_attachment.Artifact.FormattedID}; Created files:\n"%[count_workspace_attachments+1]
        # Debugging code ... don't do them all
        ...
        #
        #print "Creating artifact directory: #{dir_name_artifact}\n"
        ...
        #print         "           Wrote DATA filename=#{file_name_data}  Size=#{commatize(this_workspace_attachment.Size)}\n"
        print         "               #{file_name_data}  Size=#{commatize(this_workspace_attachment.Size)}\n"
...
print "Found a total of #{count_all_attachments} attachments in workspace; total bytes = %s\n"%[commatize(total_bytes)]
